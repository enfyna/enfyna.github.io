...
const startCanvasBGColor = "#283052";

let StartOverlayLines;
let StartOverlayLinesRadius;
const StartOverlayLineNumber = 5000;

let gameContainer;
let gameCanvas; let gameCanvas2D;
const gameCanvasBGColor = "#0E141E";

const gameBorderPos = 80;
const gameBorderThickness = 7;
const gameBorderThicknessPos = gameBorderPos - gameBorderThickness;
